...
{\sl Languages:} C\textbackslash C++, C\#, Javascript, Scala, Java, VHDL, Python\\
{\sl Platforms:} Linux, OSX, Windows\\
{\sl Software:} Vim, Git, MatLab, \LaTeX \\
{\sl Technologies:} Node.js, MongoDB, Redis, WebSockets, AngularJS, Backbone.js
...
{\sl AngularJS Seed Project } \\
Opinionated seed project for developing rich web applications
\begin{itemize} \itemsep -2pt
  \item Structured project to simplify integration with other client MVC frameworks
  \item Implemented concurrent build system to improve efficiency of development cycle
  \item Designed to be database agnostic
\end{itemize}
