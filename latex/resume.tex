...
\begin{itemize}  \itemsep -2pt %reduce space between items
  \item Improved the core backend system that processes Syslog, SNMP Trap events by implementing a simple API to handle insertions
  \item Utilized visual representations of captured logs to simplify the process of identifying problems with users networks
  \item Optimized the data displayed to the user by adding a scoring and classification mechanism to only display key events
\end{itemize}
