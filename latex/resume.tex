...
\begin{itemize}  \itemsep -2pt %reduce space between items
  \item Rewrote logging service to simplify integration with external logging facilities and internal services
  \item Prototyped modular UI to allow system administrators to dig into various aspects of their infrastructure
  \item Implemented basic classifiers to remove extraneous log messages
\end{itemize}
