...
% Again, the address lines must be centered over entire width of resume:
 ...
 \moveleft.5\hoffset\centerline{http://github.com/geverding}
...
{\sl Languages:} C, C\#, Coffeescript, Scala, Java, Python, PHP\\
{\sl Platforms:} Linux (Server/Workstation), OSX, Windows\\
{\sl Software:} Vim, zsh, Git, MatLab, \LaTeX \\
{\sl Technologies:} MongoDB, Node.js, Redis, AngularJS, Backbone.js 
