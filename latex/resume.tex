...
% Center the name over the entire width of resume:
 ...
 \moveleft.5\hoffset\centerline{3B Computer Engineering}
% Draw a horizontal line the whole width of resume:
 \moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}\smallskip
% address begins here
% Again, the address lines must be centered over entire width of resume:
 \moveleft.5\hoffset\centerline{251 Lester St.}
...
{\sl Languages:} C, C\#, Javascript, Java, Python, VHDL\\
{\sl Platforms:} Linux, OSX, Windows\\
{\sl Software:} Vim, Git, Matlab, \LaTeX\\
{\sl Technologies:} Node.js, MongoDB, Backbone.js, Redis, WebSockets
